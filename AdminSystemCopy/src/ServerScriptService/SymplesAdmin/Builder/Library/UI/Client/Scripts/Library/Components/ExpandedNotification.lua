...
module.Init = function()
	...
	frame.Container.Body.Content.TextColor3 = Theme.ExpandedNotification.PrimaryTextColor
	frame.Container.Top.Accent.BackgroundColor3 = Theme.ExpandedNotification.AccentColor
	frame.Container.Top.Title.TextColor3 = Theme.ExpandedNotification.AccentTextColor
	frame.Container.ImageColor3 = Theme.ThemeColor
	
	frame.Bottom.Primary.ImageColor3 = Theme.ThemeColor
	frame.Bottom.Primary.Content.TextColor3 = Theme.ExpandedNotification.TertiaryTextColor
end
